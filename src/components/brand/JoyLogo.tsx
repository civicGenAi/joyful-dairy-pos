    ...
    <div className="flex items-center gap-2.5" aria-label="African Joy Dairy">
      ...
      >
        <svg width={size * 0.62} height={size * 0.62} viewBox="0 0 24 24" fill="none" aria-hidden>
          <path d="M5 8c0-1.5 2-3 7-3s7 1.5 7 3v8c0 1.5-2 3-7 3s-7-1.5-7-3V8z" fill="white" opacity=".95"/>
      ...
      <div className="leading-tight">
        ...
        <div className="text-[10px] uppercase tracking-[0.14em] text-muted-foreground">Dairy · Arusha</div>
      </div>
    </div>
  );
}
