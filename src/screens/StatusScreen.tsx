...
const INCIDENTS = [
  {
    ...
    note: "Delayed receipts to one mailbox provider for 38 minutes, fully recovered.",
  },
  {
    date: "2026-05-14",
    component: "M-Pesa payments",
    note: "Operator-side maintenance window, queued transactions processed on resume.",
  },
  {
    date: "2026-04-29",
    component: "Reports engine",
    note: "Monthly report build slowed during a database failover, no data loss.",
  },
  {
    date: "2026-04-08",
    component: "WhatsApp gateway",
    note: "Template approval reset by provider, replaced within 2 hours.",
  },
];

function pill(health: Health) {
  if (health === "operational")
    return { label: "Operational", color: "#1D9E75", Icon: CheckCircle2 };
        ...
        >
          ...
          <div>
            ...
            <div className="font-display text-2xl font-bold">
              All systems {banner.label.toLowerCase()}
            </div>
          </div>
